<template>
    <AppLayout>
        ...
        <div class="max-w-3xl mx-auto p-6">
            <h1 class="text-2xl font-bold text-gray-900 mb-6">История: {{ page.title }}</h1>

            <div class="space-y-3">
                <div
                    v-for="version in versions.data"
                    :key="version.id"
                    class="flex items-center gap-4 bg-white border border-gray-200 rounded-xl px-5 py-4"
                >
